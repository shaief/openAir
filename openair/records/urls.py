...
urlpatterns = patterns('',
    ...
    url(r'^station/json/(?P<url_id>[0-9]+)/(?P<abbr>[-_ ()a-zA-Z0-9.]+)/$',
        views.stationmap_param_json, name='stationmap_param_json'),
    url(r'^station/json/(?P<url_id>[0-9]+)/$',
    ...
    url(r'^station_parameters/(?P<url_id>[0-9]+)/(?P<abbr>[-_ ()a-zA-Z0-9.]+)/$',
        views.station_parameters, name='stationmap_param'),
    url(r'^wind/(?P<zone_url_id>[0-9]+)/(?P<station_url_id>[0-9]+)/$',
        views.wind, name='wind'),
    url(r'^wind/json/(?P<url_id>[0-9]+)/$',
