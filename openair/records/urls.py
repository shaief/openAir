...
urlpatterns = patterns('',
    ...
    url(r'^stationmap/json/(?P<url_id>[-_()a-zA-Z0-9]+)/(?P<abbr>[-_()a-zA-Z0-9.]+)/$',
            views.stationmap_param_json, name='stationmap_param_json'),
    url(r'^stationmap/json/(?P<url_id>[-_()a-zA-Z0-9 ]+)/$',
            views.stationmap_json, name='stationmap_json'),
    url(r'^stationmap/(?P<url_id>[-_()a-zA-Z0-9 ]+)/$',
            views.stationmap, name='stationmap'),
    url(r'^stationparams/(?P<url_id>[-_()a-zA-Z0-9 ]+)/$',
            views.stationparams, name='stationparams'),
    url(r'^stationmapparam/(?P<url_id>[-_()a-zA-Z0-9]+)/(?P<abbr>[-_()a-zA-Z0-9.]+)/$',
